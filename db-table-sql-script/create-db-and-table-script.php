...
include 'header.php';
	...
	{	
		...
		if (!$result)
		{
		mysql_query("CREATE TABLE grading_sheets (grading_sheets_id int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, fgrades double, term_id int(11), subject_enrolled_id int(11))") or die(mysql_error());  
		...
		if (!$result)
		{
		mysql_query("CREATE TABLE semester(semester_id int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, semester_name char(5), school_year_id int(11))") or die(mysql_error());  
		...
		if (!$result)
		{
		mysql_query("CREATE TABLE term(term_id int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, term_name varchar(10), semester_id int(11))") or die(mysql_error());  
		...
		if (!$result)
		{
		mysql_query("CREATE TABLE subject(subject_code varchar(11) NOT NULL PRIMARY KEY, subject_name varchar(100))") or die(mysql_error());  
		...
		if (!$result)
		{
		mysql_query("CREATE TABLE subject_offered(subject_offered_id int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT, subject_code varchar(11), instructor_id int(11), student_id varchar(8))") or die(mysql_error());  
